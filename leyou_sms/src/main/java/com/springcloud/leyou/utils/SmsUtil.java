package com.springcloud.leyou.utils;
...
import com.springcloud.leyou.redis.RedisUtils;
...
public class SmsUtil {
    ...
    public SendSmsResponse sendSms(String signature, String templateCode, String phone, String params) {

        try {

            String key = SMS_PREFIX + phone;

            String lastTime = (String) redisUtils.get(key);
           ...
           // request.setOutId("123456");
            ...
            redisUtils.set(key,String.valueOf(System.currentTimeMillis()),1,TimeUnit.MINUTES);
